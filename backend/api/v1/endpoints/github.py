...
async def get_repositories(owner: str, owner_type: str, current_user: User = Depends(get_current_user)):
...
async def get_repository_contents(owner: str, repo: str, path: str = "", current_user: User = Depends(get_current_user)):
