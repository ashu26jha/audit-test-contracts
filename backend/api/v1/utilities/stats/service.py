...
from api.v1.utilities.stats.schema import (
    GlobalStatsResponse,
    TotalPaidScansBreakdown,
...
class StatsService:
    ...
    async def get_global_stats() -> GlobalStatsResponse:
        ...
        try:
            ...
            returning_users_result = await Scan.aggregate(returning_users_pipeline).to_list(
                length=1
            )
            returning_users = (
    ...
    @staticmethod
    async def get_24h_stats() -> TwentyFourHStatsResponse:
        """
        ...
        return TwentyFourHStatsResponse(
