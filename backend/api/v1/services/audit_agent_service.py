...
from api.v1.services import context_scan_service, generate_summary_service
from common.profiles import Profiles


async def perform_audit_agent(contracts: str):
    # Step 1: Generate Summary and detect profiles
    summary_result, detected_profile = await generate_summary_service.generate_summary(contracts)
