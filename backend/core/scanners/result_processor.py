...
class BaseResultsProcessor:
    ...
    async def process_results(self) -> int:
        ...
        5. Enrich non-static findings (add additional insights and adjust severity)
        ...
        # 4. Perform validation on non-static findings and contract contents
        ...
        # 5. Enrich non-static findings with additional insights and adjust severity
