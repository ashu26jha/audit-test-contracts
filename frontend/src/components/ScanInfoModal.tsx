        ...
        <ModalBody>
          <div className="flex flex-row gap-1 bg-[#18181B] m-4 rounded-lg p-4">
            <div className="flex flex-col gap-1 border-r border-[#27272A] p-4">
              <Image src="/svg/beta.svg" width={60} height={60} alt="beta" />
            </div>
          ...
          <div className="flex flex-row gap-1 bg-[#18181B] m-4 rounded-lg p-4">
            <div className="flex flex-col gap-1 border-r border-[#27272A] p-4">
              <Image src="/svg/vulnerability.svg" width={60} height={60} alt="vulnerability" />
            </div>

            <div className="flex flex-col gap-1 ml-4 mt-2 mb-2">
              <p className="text-sm text-white mt-2">Top Finding is Free</p>
              <p className="text-sm text-gray-400 mb-2 mt-2 mr-2">
                Get the most critical vulnerability for free. Pay <s>$100</s> $20 to get the full report with detailed
                insights.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row gap-1 bg-[#18181B] m-4 rounded-lg p-4">
            <div className="flex flex-col gap-1 border-r border-[#27272A] p-4">
              <Image src="/svg/code.svg" width={60} height={60} alt="code" />
            </div>
