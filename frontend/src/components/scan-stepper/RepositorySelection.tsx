...
export const RepositorySelection: FC = () => {
  ...
  return (
    <div className="w-2/5 min-w-[250px]">
      ...
      {!hasGithubApp && (
        <div className="flex flex-col items-center gap-3 p-4 border border-default-200 rounded-lg bg-content1">
          <p className="text-sm text-default-600 text-center">
            To scan private repositories, you&apos;ll need to install our GitHub App. This gives us secure, limited read
            access to your repositories.
          </p>
          <Button
            color="secondary"
            className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-white font-medium"
            onPress={() => (window.location.href = SERVICES.GITHUB_APP_URL)}
