  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center">
      <Card className="bg-[#222222] p-8 max-w-md w-full text-center">
        ...
        {status === 'success' ? (
          <p className="text-gray-400 mb-6">
            You will receive the full vulnerabilities report shortly on the
            following email:
            <br />
          ...
          <p className="text-gray-400 mb-6">
            We did not receive your payment, please try again!
          </p>
        )}
        {status === 'success' ? (
          <Button
      ...
      <p className="text-gray-500 mt-8 text-sm">
        Need help? Reach out to us at help@auditgent.rethemind.io
      </p>
    </div>
  );
};
